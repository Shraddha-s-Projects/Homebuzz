...
<<<<<<< HEAD:Web/src/app/modal/my-homes/my-homes.component.ts
    let address = home.Address + ", " + home.Suburb + ", " + home.City;
    window.history.pushState(null, null, this.pageName + '/edit/' + address.replace(/[\W_]/g, "-") + "/" + home.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openAddEditPropertyDialog("AddEditHomePhotoDescriptionComponent", home.PropertyDetailId, address);
=======
    this.window.history.pushState(null, null, this.pageName + '/edit/' + home.Address.replace(/[\W_]/g, "-") + "/" + home.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openAddEditPropertyDialog("AddEditHomePhotoDescriptionComponent", home.PropertyDetailId, home.Address);
    // this.router.navigate(['/' + this.pageName + '/edit/' + home.Address.replace(/[\W_]/g, "-") + "/" + home.PropertyDetailId + "/" + this.getRandom()]);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/modal/my-homes/my-homes.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/modal/my-homes/my-homes.component.ts
    ...
    window.history.pushState(null, null, this.pageName + '/removeoffer/' + address.replace(/[\W_]/g, "-") + "/" + id + "/" + this.getRandom());
...
=======
    ...
    this.commonModalService.openRemoveOfferDialog("RemovePropertyOfferComponent", id, Address);
    // this.router.navigate(['/' + this.pageName + '/removeoffer/' + Address.replace(/[\W_]/g, "-") + '/' + id + "/" + this.getRandom()]);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/modal/my-homes/my-homes.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/modal/my-homes/my-homes.component.ts
    window.history.pushState(null, null, this.pageName + '/negotiateOffer/' + address.replace(/[\W_]/g, "-") + "/" + offer.Id + "/" + this.getRandom());
    this.commonModalService.openNegotiateOfferDialog("NegotiatePropertyOfferComponent", offer.Id, address);
=======
    this.window.history.pushState(null, null, this.pageName + '/negotiateOffer/' + offer.Address.replace(/[\W_]/g, "-") + "/" + offer.Id + "/" + this.getRandom());
    this.commonModalService.openNegotiateOfferDialog("NegotiatePropertyOfferComponent", offer.Id, offer.Address);
    // this.router.navigate(['/' + this.pageName + '/negotiateOffer/' + offer.Address.replace(/[\W_]/g, "-") + '/' + offer.Id + "/" + this.getRandom()]);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/modal/my-homes/my-homes.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/modal/my-homes/my-homes.component.ts
    let address = home.Address + ", " + home.Suburb + ", " + home.City;
    window.history.pushState(null, null, this.pageName + '/transferowner/' + address.replace(/[\W_]/g, "-") + "/" + home.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openTransferOwnershipDialog("TransferOwnershipComponent", home.PropertyDetailId, address);
=======
    this.window.history.pushState(null, null, this.pageName + '/transferowner/' + home.Address.replace(/[\W_]/g, "-") + "/" + home.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openTransferOwnershipDialog("TransferOwnershipComponent", home.PropertyDetailId, home.Address);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/modal/my-homes/my-homes.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/modal/my-homes/my-homes.component.ts
    let address = home.Address + ", " + home.Suburb + ", " + home.City;
    window.history.pushState(null, null, this.pageName + '/unclaimhome/' + address.replace(/[\W_]/g, "-") + "/" + home.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openUnclaimDialog("UnclaimHomeComponent", home.PropertyDetailId, address);
=======
    this.window.history.pushState(null, null, this.pageName + '/unclaimhome/' + home.Address.replace(/[\W_]/g, "-") + "/" + home.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openUnclaimDialog("UnclaimHomeComponent", home.PropertyDetailId, home.Address);
    // this.router.navigate(['/'+ this.pageName + '/unclaimhome/' +  home.Address.replace(/[\W_]/g, "-")  + '/' + home.PropertyDetailId + "/" + this.getRandom()]);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/modal/my-homes/my-homes.component.ts
  }
