...
<<<<<<< HEAD:Web/src/app/pages/signup/signup.component.ts
...
declare var $: any;
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/signup/signup.component.ts
...
export class SignupComponent implements OnInit {
  ...
  openAlreadySignUpModal() {
    ...
    dialogConfirmRef.componentInstance.message =
      "<p class='mb-0 font-15'>That email address seems to already be registered with us.</p>" +
      "<p class='mb-0 font-15'>Please check the spelling or submit a new email address to use for your account in the PropertyLight system.</p>";
  ...
  openSignUpSuccessModal() {
    ...
    dialogConfirmRef.componentInstance.message =
      "<p class='mb-0 font-15'>An email has been sent to you to confirm your address and complete the " +
      "sign up process.</p><br/>" +
      "<p class='mb-0 font-15'>If you don't see it in a few minutes, please check your spam " +
      "folder for an email from PropertyLight.</p>";
    dialogConfirmRef.componentInstance.btnText1 = "OK - I GOT IT!";
  ...
  openSomethingWentWrongModal() {
    ...
    dialogConfirmRef.componentInstance.title = "Whoops!";
    dialogConfirmRef.componentInstance.message =
      "<p class='mb-0'>Sorry, something went wrong. An unexpected error has occurred.</p>" +
