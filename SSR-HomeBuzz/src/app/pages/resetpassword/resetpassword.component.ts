...
export class ResetpasswordComponent implements OnInit {
  ...
  openResetPasswordModal() {
    ...
    dialogConfirmRef.componentInstance.title = "On It's Way!";
    dialogConfirmRef.componentInstance.message =
      "<p class='mb-0 font-15'>We have sent you a temporary link to reset your password in PropertyLight!</p>" +
      "<p class='mb-0 font-15'>Please note that this temporary link will only work for the next 24 hours!</p>" +
      "<p class='mb-0 font-15'>If you don't see it in a few minutes, please check your spam or clutter folders for an email from PropertyLight.</p>";
