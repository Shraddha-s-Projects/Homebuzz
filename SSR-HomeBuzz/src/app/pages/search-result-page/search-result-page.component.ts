...
export class SearchResultPageComponent implements OnInit, OnDestroy {
  ...
  constructor(@Inject(WINDOW) private window: Window, @Inject(LOCAL_STORAGE) private localStorage: any, 
    ...
    //     this.PageNum = 1;
    //     this.searchTermViewPort = JSON.parse(localStorage.getItem("SearchData"));
    //     this.getUserInfo();
    ...
    //   }
    // );
    // this.eventEmitterService.subsVar = this.eventEmitterService.invokeSearchResultPageAddressRefresh.subscribe(
    //   () => {
    ...
    // this.eventEmitterService.subsVar = this.eventEmitterService.propertyImageModal.subscribe(
    //   (element: any) => {
    //     this.openPropertyImageModal(element);
    //   }
    // );

    // this.eventEmitterService.subsVar = this.eventEmitterService.zoomMapEvent.subscribe(
    //   () => {
    //     this.showLoader();
    //   }
    // );

    // this.eventEmitterService.subsVar = this.eventEmitterService.likePropertyEvent.subscribe(
    //   (property: any) => {
    //     this.onTileLikeClickChildOutut(property);
    //   }
    // );

    // this.eventEmitterService.subsVar = this.eventEmitterService.shareModalEvent.subscribe(
    //   (property: any) => {
    //     this.openShareDialog(SharePropertyComponent);
    //   }
    // );

    // this.eventEmitterService.subsVar = this.eventEmitterService.notifyPropertyModalEvent.subscribe(
    //   (property: any) => {
    //     this.openNotifyPropertyDialog(NotifyPropertyComponent, property.PropertyDetailId);
    //   }
    // );

    // this.eventEmitterService.subsVar = this.eventEmitterService.termsModalEmit.subscribe(
    //   (property: any) => {
    //     this.onTermsOptionClick();
    //   }
    // );

    // this.eventEmitterService.subsVar = this.eventEmitterService.estimateModalEmit.subscribe(
    //   (property: any) => {
    //     this.onHomebuzzEstimatesOptionClick();
    //   }
    // );

    // this.eventEmitterService.subsVar = this.eventEmitterService.privacyModalEmit.subscribe(
    //   (property: any) => {
  ...
  ngOnInit() {
    ...
    this.isUserCookieExist ? this.getUserInfo() : false;
...
<<<<<<< HEAD:Web/src/app/pages/search-result-page/search-result-page.component.ts
    // $(window).scroll(function () {
    //   if ($(window).scrollTop() >= 50) {
    //     $('.sub-header').addClass('sub-header-mobile');
    //   }
    //   else {
    //     $('.sub-header').removeClass('sub-header-mobile');
    //   }
    // });

    let el: HTMLCollectionOf<Element> = document.getElementsByClassName('sub-header');
    if ($(window).scrollTop() >= 50) {
      if (el) {
...
=======
    $(this.window).scroll(function () {
      if ($(this.window).scrollTop() >= 50) {
        $('.sub-header').addClass('sub-header-mobile');
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/search-result-page/search-result-page.component.ts
      }
    }
    else {
      if (el) {
...
<<<<<<< HEAD:Web/src/app/pages/search-result-page/search-result-page.component.ts
    this.isUserCookieExist ? parseInt(localStorage.getItem("userId")) : null;
...
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/search-result-page/search-result-page.component.ts
  ...
  onScroll(value: number): void {
    let ell: HTMLElement = document.getElementById('address-grid');
    var offsetHeight = ell.offsetHeight;
    let scrollOffset = offsetHeight * (this.totalHome / 5);
    // let scrollOffset = $("#address-grid").height() * (this.totalHome / 5);
    this.scrollOffset = scrollOffset;
    let scrollTop =  ell.scrollTop;
    if(scrollTop >= scrollOffset && scrollOffset){
      this.onScrollEnd();
    }
    // if ($("#address-grid").scrollTop() >= scrollOffset && scrollOffset) {
    //   this.onScrollEnd();
    // }
  }
  ...
  MinFocus(event) {
    var max = document.getElementById('MaxList');
    max.style.display = "none";
    var min = document.getElementById('MinList');
  ...
  onStatusSelect(event) {
    ...
    if (event.target.checked) {
      ...
      var arr = this.selectedStatus.split(',');
  ...
  OnMinPriceSelect(event) {
    ...
    if (this.selectedMinPrice >= 1000) {
      ...
      this.minPz = this.selectedMinPrice.toString();
    }
...
<<<<<<< HEAD:Web/src/app/pages/search-result-page/search-result-page.component.ts
      ...
      window.history.pushState(null, null, 'property/claimhome/' + address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
      this.openClaimHomeDialog("ClaimHomeComponent", prop.PropertyDetailId, address);
=======
      // this.router.navigate(['/property/claimhome/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId+ "/" + this.getRandom()]);
      this.window.history.pushState(null, null, 'property/claimhome/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
      this.openClaimHomeDialog("ClaimHomeComponent", prop.PropertyDetailId, prop.Address);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/search-result-page/search-result-page.component.ts
    }
  }
  ...
  makeOffer(property: any) {
    if (!this.isUserCookieExist) {
      ...
      // this.makeOfferModal.PropertyDetailId = property.PropertyDetailId;
      // this.makeOfferModal.PropertyAddress = property.Address;
      // this.makeOfferModal.show();
      this.modalProperty = property;
      this.modalComponent = MakeOfferComponent;
<<<<<<< HEAD:Web/src/app/pages/search-result-page/search-result-page.component.ts
      let address = property.Address + ", " + property.Suburb + ", " + property.City;
      window.history.pushState(null, null, 'property/makeoffer/' + address.replace(/[\W_]/g, "-") + "/" + property.PropertyDetailId + "/" + this.getRandom());
      this.openMakeOfferDialog('MakeOfferComponent', property.PropertyDetailId, address);
=======
      this.window.history.pushState(null, null, 'property/makeoffer/' + property.Address.replace(/[\W_]/g, "-") + "/" + property.PropertyDetailId + "/" + this.getRandom());
      this.openMakeOfferDialog('MakeOfferComponent', property.PropertyDetailId, property.Address);
      // this.router.navigate(['/property/MakeOffer/' + property.Address.replace(/[\W_]/g, "-") + "/" + property.PropertyDetailId+ "/" + this.getRandom()]);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/search-result-page/search-result-page.component.ts
    }
  }
...
<<<<<<< HEAD:Web/src/app/pages/search-result-page/search-result-page.component.ts
    let address = property.Address + ", " + property.Suburb + ", " + property.City;
    window.history.pushState(null, null, 'property/edit/' + address.replace(/[\W_]/g, "-") + "/" + property.PropertyDetailId + "/" + this.getRandom());
    this.openAddEditPropertyDialog("AddEditHomePhotoDescriptionComponent", property.PropertyDetailId, address);
=======
    this.window.history.pushState(null, null, 'property/edit/' + property.Address.replace(/[\W_]/g, "-") + "/" + property.PropertyDetailId + "/" + this.getRandom());
    this.openAddEditPropertyDialog("AddEditHomePhotoDescriptionComponent", property.PropertyDetailId, property.Address);
    // this.router.navigate(['/property/edit/' + property.Address.replace(/[\W_]/g, "-") + "/" + property.PropertyDetailId+ "/" + this.getRandom()]);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/search-result-page/search-result-page.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/pages/search-result-page/search-result-page.component.ts
    let address = prop.Address + ", " + prop.Suburb + ", " + prop.City;
    window.history.pushState(null, null, 'property/detail/' + address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.openDialog("PropertyImageGalleryComponent", prop.PropertyDetailId, address);
=======
    this.window.history.pushState(null, null, 'property/detail/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.openDialog("PropertyImageGalleryComponent", prop.PropertyDetailId, prop.Address);
    // this.router.navigate(['/property/detail/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom()]);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/search-result-page/search-result-page.component.ts
  }
...
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/search-result-page/search-result-page.component.ts
  ...
  togglemaplist(toggle: string) {
    if (toggle.toLowerCase() === 'list') {
      ...
      let el: HTMLCollectionOf<Element> = document.getElementsByClassName('map-width');
      if (el.length > 0) {
        el[0].classList.remove('show');
        el[0].classList.add('hide');
      }
      let el1: HTMLCollectionOf<Element> = document.getElementsByClassName('map-btn');
      if (el1.length > 0) {
        el1[0].classList.add('show');
        el1[0].classList.remove('hide');
      }
      let el2: HTMLCollectionOf<Element> = document.getElementsByClassName('list-btn');
      if (el2.length > 0) {
        el2[0].classList.add('hide');
        el2[0].classList.remove('show');
      }
      let cardwidth: HTMLCollectionOf<Element> = document.getElementsByClassName('card-width');
      ...
      let mapbtn: HTMLCollectionOf<Element> = document.getElementsByClassName('map-btn');
      if (mapbtn.length > 0) {
        mapbtn[0].classList.add("hide");
        mapbtn[0].classList.remove("show");
      }
      let listbtn: HTMLCollectionOf<Element> = document.getElementsByClassName('list-btn');
      if (listbtn.length > 0) {
  ...
  SavePropertySearch() {
    ...
    let viewport = {};
    let search = JSON.parse(this.localStorage.getItem('SearchData'));
    ...
    if (this.isAllActiveStatus) {
      viewport["PropertyStatus"] = this.propertyStatus.find(t => t.Name === "All").Id.toString();
    } else {
  ...
  openNegotiateOfferDialog(componentName, Id, address) {
    ...
    dialogRef.afterClosed().subscribe(res => {
      ...
      history.pushState(this.properties, null, environment.StaticUrl.toString());
    });
  }
