...
export class AgentDashboardComponent implements OnInit, OnDestroy {
  ...
  getAgentProperties(AgentOptionId) {
    ...
    let obj = {
      ...
      // EndDate: moment(this.date.toString()).add(1, 'days').format("YYYY-MM-DD HH:mm:ss"),
    }
    // this.properties = [];
    this.isLoaded = false;
...
<<<<<<< HEAD:Web/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
    let address = prop.Address + ", " + prop.Suburb + ", " + prop.City;
    window.history.pushState(null, null, "agent/" + this.pageName + '/edit/' + address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
...
=======
    this.window.history.pushState(null, null, "agent/" + this.pageName + '/edit/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openAddEditPropertyDialog("AddEditHomePhotoDescriptionComponent", prop.PropertyDetailId, prop.Address, true);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
    let address = prop.Address + ", " + prop.Suburb + ", " + prop.City;
    window.history.pushState(null, null, "agent/" + this.pageName + '/claimhome/' + address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openClaimHomeDialog("ClaimHomeComponent", prop.PropertyDetailId, address, true);
=======
    this.window.history.pushState(null, null, "agent/" + this.pageName + '/claimhome/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openClaimHomeDialog("ClaimHomeComponent", prop.PropertyDetailId, prop.Address, true);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
    let address = prop.Address + ", " + prop.Suburb + ", " + prop.City;
    window.history.pushState(null, null, "agent/" + this.pageName + '/propertyoffers/' + address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openPropertyOffersDialog("PropertyOffersComponent", prop.PropertyDetailId, address, true);
=======
    this.window.history.pushState(null, null, "agent/" + this.pageName + '/propertyoffers/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openPropertyOffersDialog("PropertyOffersComponent", prop.PropertyDetailId, prop.Address, true);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
  }
...
<<<<<<< HEAD:Web/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
    let address = prop.Address + ", " + prop.Suburb + ", " + prop.City;
    window.history.pushState(null, null, "agent/" + this.pageName + '/transferowner/' + address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openTransferOwnershipDialog("TransferOwnershipComponent", prop.PropertyDetailId, address, true);
=======
    this.window.history.pushState(null, null, "agent/" + this.pageName + '/transferowner/' + prop.Address.replace(/[\W_]/g, "-") + "/" + prop.PropertyDetailId + "/" + this.getRandom());
    this.commonModalService.openTransferOwnershipDialog("TransferOwnershipComponent", prop.PropertyDetailId, prop.Address, true);
>>>>>>> d44a2129a61e87498ddcedeb1c2d5fdaffff25d0:SSR-HomeBuzz/src/app/pages/agent-pages/agent-dashboard/agent-dashboard.component.ts
  }
